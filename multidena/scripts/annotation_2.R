...
#files <- "/home/anton/Downloads/ann.pwm.bed;/home/anton/Downloads/ann.bamm.bed;/home/anton/Downloads/ann.sitega.bed"
#tools <- "PWM;BaMM;SiteGA"
#genome <- "tair10"
#writeDirectory <- '/home/anton/Downloads/tmp'
...
readAnnotation <- function(path){
  df <- read.table(path)
  colnames(df) <- c("chr", "start", "end", "strand", "gene")
  gr <- makeGRangesFromDataFrame(df, keep.extra.columns=TRUE)
  return(gr$gene)
}

genes <-  lapply(files, readAnnotation)
