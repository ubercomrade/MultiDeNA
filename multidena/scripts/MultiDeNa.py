    ...
    if organism in ['mm10', 'hg38', 'tair10']:
        ...
        for tag in ['train', 'test']:
            ...
            for tool in tools:
                ...
                path_ann = pkg_resources.resource_filename('multidena', f'promoters/promoters_ts_{organism}.p2000m300.bed')
...
def parse_args():
    ...
    parser.add_argument('models', action='store', type=str,
                        metavar='M',help='The comma-separated list of models that will be used in analysis to use. \
...
def main():
    ...
    #Check tools
    avaliable_options=['pwm-chipmunk', 'pwm-streme', 'dipwm', 'bamm', 'inmode', 'sitega']
    tools = [t for t in tools if t in avaliable_options]
